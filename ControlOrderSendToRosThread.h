 ...
 * ControlOrderSendThread直接通过串口发往小车 \n
 * 在ProcessRunNoGPSDialog中用宏定义选择 \n
 */
...
public:
    /**
     * @brief Construct a new ControlOrderSendToRosThread object
     * @param  parent           父对象指针
     */
    ControlOrderSendToRosThread(QObject *parent);
    /**
     * @brief Destroy the ControlOrderSendToRosThread  object
     */
...
private:
    ...
    /**
     * @brief  发送转向信息
     * @param  ordientation         转向值
     * @param  order_simulate_pub   消息公布节点，用来发送转向信息
     */
    void sendTurnOrder(int ordientation, ros::Publisher order_simulate_pub);
